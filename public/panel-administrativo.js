...
function setupEventListeners() {
    ...
    document.getElementById('searchSensores').addEventListener('input', () => renderSensores());
}
...
async function loadData() {
    try {
        ...
        // Cargar sensores (simulados por ahora)
        sensores = [
            { _id: '1', nombre: 'Sensor Temperatura', ubicacion: 'Laboratorio A', estado: 'activo', ultimaLectura: new Date() },
            { _id: '2', nombre: 'Sensor Humedad', ubicacion: 'Aula 101', estado: 'activo', ultimaLectura: new Date() },
            { _id: '3', nombre: 'Sensor Luz', ubicacion: 'Jardín', estado: 'inactivo', ultimaLectura: new Date() }
        ];

        // Cargar historial (simulado por ahora)
        historial = [
            { usuario: 'maria@escuela.edu.mx', accion: 'creó proyecto', descripcion: 'Proyecto de huerto escolar', fecha: new Date(), ip: '192.168.1.100' },
            { usuario: 'carlos@escuela.edu.mx', accion: 'publicó en foro', descripcion: 'Nueva idea para reciclaje', fecha: new Date(), ip: '192.168.1.101' },
            { usuario: 'ana@escuela.edu.mx', accion: 'editó perfil', descripcion: 'Actualizó información de escuela', fecha: new Date(), ip: '192.168.1.102' }
        ];
